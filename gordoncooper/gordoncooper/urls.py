...
urlpatterns = patterns('',
    ...
    url(r'^downloads$', ListView.as_view(), {'type': 'download'}, name='downloads'),
    url(r'^agenda$', ListView.as_view(), {'type': 'diary'}, name='diary'),
    url(r'^galeria$', ListView.as_view(), {'type': 'gallery'}, name='gallery'),
    url(r'^$', ListView.as_view(), {'type': None}, name='home'),
